...
class GrupoVello {
    ...
    * Requiere como parámetros las dos casillas miembro y el color del grupo.
     */
    public GrupoVello(Casillavella cas1, Casillavella cas2, String colorGrupo) {
    ...
    * Requiere como parámetros las tres casillas miembro y el color del grupo.
     */
    public GrupoVello(Casillavella cas1, Casillavella cas2, Casillavella cas3, String colorGrupo) {
        this.miembros = new ArrayList<Casillavella>();
        this.miembros.add(cas1);
        cas1.setGrupo(this);
        this.miembros.add(cas2);
